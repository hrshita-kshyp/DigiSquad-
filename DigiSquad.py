...
def engine_speak(audio_string):
    ...
    tts = gTTS(text=audio_string, lang='hi')  # text to speech(voice)
...
def respond(voice_data):
    ...
    if there_exists(['hey', 'hi', 'hello']):
        greetings = ["hey I m DigiSquad, how can I help you" + person_obj.name, "hey, what's up?" + person_obj.name,
